...
// Esta actividad se muestra cuando se hace clic en cierto pokemon para proporcionar su información detallada.
// En realidad, no se proporciona información detallada,
// porque como dije anteriormente en el archivo "Pokemon", la información detallada está en una URL diferente,
// que también debe recuperarse para ver la descripción del pokemon.
public class PokemonDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            String name = intent.getStringExtra("name"); // obtiene la información del intento en la clase Pokemon
            ...
            // Crea una cadena separada por comas de los tipos
